...
This runs the TypeScript build, doc generation, all e2e tests, and all unit tests. E2e tests never call a live LLM. Build, doc, and e2e failures are blocking.
