...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Groq | `groq` | openai-compat | `GROQ_API_KEY` | Yes | No | `openai/gpt-oss-safeguard-20b`<br>`llama-3.3-70b-versatile`<br>`meta-llama/llama-prompt-guard-2-22m`<br>`allam-2-7b`<br>`canopylabs/orpheus-arabic-saudi`<br>`groq/compound`<br>`whisper-large-v3`<br>`meta-llama/llama-4-scout-17b-16e-instruct`<br>`canopylabs/orpheus-v1-english`<br>`openai/gpt-oss-20b`<br>`openai/gpt-oss-120b`<br>`llama-3.1-8b-instant`<br>`groq/compound-mini`<br>`qwen/qwen3-32b`<br>`meta-llama/llama-prompt-guard-2-86m`<br>`whisper-large-v3-turbo` |
