...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Groq | `groq` | openai-compat | `GROQ_API_KEY` | Yes | No | `allam-2-7b`<br>`groq/compound`<br>`groq/compound-mini`<br>`llama-3.1-8b-instant`<br>`llama-3.3-70b-versatile`<br>`meta-llama/llama-4-scout-17b-16e-instruct`<br>`openai/gpt-oss-120b`<br>`openai/gpt-oss-20b`<br>`openai/gpt-oss-safeguard-20b`<br>`qwen/qwen3-32b` |
