...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Groq | `groq` | openai-compat | `GROQ_API_KEY` | Yes | No | `qwen/qwen3-32b`<br>`whisper-large-v3`<br>`groq/compound`<br>`meta-llama/llama-4-scout-17b-16e-instruct`<br>`openai/gpt-oss-20b`<br>`groq/compound-mini`<br>`openai/gpt-oss-120b`<br>`allam-2-7b`<br>`llama-3.1-8b-instant`<br>`canopylabs/orpheus-arabic-saudi`<br>`llama-3.3-70b-versatile`<br>`meta-llama/llama-prompt-guard-2-86m`<br>`openai/gpt-oss-safeguard-20b`<br>`canopylabs/orpheus-v1-english`<br>`meta-llama/llama-prompt-guard-2-22m`<br>`whisper-large-v3-turbo` |
...
| 8 | Cerebras | `cerebras` | openai-compat | `CEREBRAS_API_KEY` | Yes | No | `zai-glm-4.7`<br>`qwen-3-235b-a22b-instruct-2507`<br>`gpt-oss-120b`<br>`llama3.1-8b` |
