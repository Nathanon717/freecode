...
| 12 | OpenCode Zen | `zen` | openai-compat | `OPENCODE_ZEN_API_KEY` | Yes | No | `big-pickle`<br>`deepseek-v4-flash-free`<br>`mimo-v2.5-free`<br>`minimax-m3-free`<br>`nemotron-3-super-free`<br>`nemotron-3-ultra-free` |
