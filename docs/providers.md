...
| 5 | LLM7 | `llm7` | openai-compat | `LLM7_API_KEY` | Yes | No | `codestral-latest`<br>`devstral-small-2:24b` |
...
| 8 | Cerebras | `cerebras` | openai-compat | `CEREBRAS_API_KEY` | Yes | No | `gemma-4-31b`<br>`gpt-oss-120b`<br>`zai-glm-4.7` |
...
| 10 | Cloudflare | `cloudflare` | openai-compat | `CLOUDFLARE_API_KEY` | Yes | No | `@cf/deepseek-ai/deepseek-r1-distill-qwen-32b`<br>`@cf/meta/llama-3.3-70b-instruct-fp8-fast`<br>`@cf/qwen/qwen2.5-coder-32b-instruct` |
...
| 13 | OpenCode | `zen` | openai-compat | `OPENCODE_ZEN_API_KEY` | Yes | No | `big-pickle`<br>`deepseek-v4-flash-free`<br>`hy3-free`<br>`mimo-v2.5-free`<br>`nemotron-3-ultra-free`<br>`north-mini-code-free` |
...
| 15 | Anthropic | `anthropic` | anthropic | `ANTHROPIC_API_KEY` | Yes | Yes | `claude-fable-5`<br>`claude-haiku-4-5-20251001`<br>`claude-opus-4-1-20250805`<br>`claude-opus-4-5-20251101`<br>`claude-opus-4-6`<br>`claude-opus-4-7`<br>`claude-opus-4-8`<br>`claude-sonnet-4-5-20250929`<br>`claude-sonnet-4-6`<br>`claude-sonnet-5` |
