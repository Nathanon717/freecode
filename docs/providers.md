...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Groq | `groq` | openai-compat | `GROQ_API_KEY` | Yes | No | `openai/gpt-oss-safeguard-20b`<br>`openai/gpt-oss-20b`<br>`allam-2-7b`<br>`openai/gpt-oss-120b`<br>`meta-llama/llama-prompt-guard-2-22m`<br>`whisper-large-v3-turbo`<br>`llama-3.3-70b-versatile`<br>`llama-3.1-8b-instant`<br>`meta-llama/llama-prompt-guard-2-86m`<br>`qwen/qwen3-32b`<br>`canopylabs/orpheus-v1-english`<br>`groq/compound-mini`<br>`groq/compound`<br>`meta-llama/llama-4-scout-17b-16e-instruct`<br>`whisper-large-v3`<br>`canopylabs/orpheus-arabic-saudi` |
...
| 8 | Cerebras | `cerebras` | openai-compat | `CEREBRAS_API_KEY` | Yes | No | `gpt-oss-120b`<br>`llama3.1-8b`<br>`zai-glm-4.7`<br>`qwen-3-235b-a22b-instruct-2507` |
