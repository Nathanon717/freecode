...
- **Imported by:** [`commands/config.ts`](../commands/config.md) ×8, [`providers/provider-registry.ts`](../providers/provider-registry.md) ×5, [`commands/model.ts`](../commands/model.md) ×3, [`agent/loop.ts`](../agent/loop.md) ×2, [`cli/command-dispatcher.ts`](../cli/command-dispatcher.md) ×2, [`cli/session-modes.ts`](../cli/session-modes.md) ×2, [`providers/adapters/openai-compat.ts`](../providers/adapters/openai-compat.md) ×2, [`providers/quota/cache.ts`](../providers/quota/cache.md) ×2, +6 more

## Tests

`tests/config/index.test.ts`. 8 other test files reference it.
