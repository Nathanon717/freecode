...
**Read when:** Tracing how a model picker pricing badge's `confidence` is set, debugging "sources disagree" or missing pricing, or adding support for a new provider's pricing.
