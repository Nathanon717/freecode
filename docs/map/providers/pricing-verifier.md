...
Dual-source pricing verifier. Fetches rates from LiteLLM and OpenRouter in parallel, compares them, and returns a confidence-tagged result used to color-code cost estimates in the UI.
