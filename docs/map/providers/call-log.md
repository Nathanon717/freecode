# src/providers/call-log.ts - Per-Call LLM Log
...
- [quota/headers.md](quota/headers.md): the complementary source — header *ceilings*, versus this file's observed *usage*.
