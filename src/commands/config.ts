...
const SETTINGS: Setting[] = [
  ...
  { type: 'number',  key: 'retryMaxWaitSeconds', label: 'Max retry wait', description: 'Max backoff when a provider gives no retry-after (a retry-after is always honored in full)', min: 5, max: 300, step: 5, unit: 's', globalOnly: true },
