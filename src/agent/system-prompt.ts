...
Available tools: read_file, write_file, grep, shell_exec, list_dir

RULES - MUST ALWAYS FOLLOW:
- Use list_dir BEFORE making any assumptions about what files/folders exist.
- When editing files, use write_file with the complete new file content. Use real newlines in file content, never the literal two-character sequence backslash-n.
