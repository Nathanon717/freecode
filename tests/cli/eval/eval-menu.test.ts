...
vi.mock('../../../src/cli/menus/menu-shell.js', () => ({
...
vi.mock('../../../src/cli/menus/list-menu.js', () => ({ runListMenu: vi.fn() }));
...
vi.mock('../../../src/cli/eval/custom-eval-menu.js', () => ({
...
vi.mock('../../../src/cli/eval/humaneval-menu.js', () => ({
...
vi.mock('../../../src/store/db.js', () => ({ ensureStoreReady: vi.fn(() => Promise.resolve()) }));
const mockAccent = Object.assign((s: string) => s, { bold: (s: string) => s, black: (s: string) => s });
vi.mock('../../../src/cli/render/banner.js', () => ({ redrawBanner: vi.fn(), getBannerColor: () => mockAccent, getBannerColorRGB: () => [170, 232, 255] as [number, number, number] }));
vi.mock('fs', () => ({ existsSync: vi.fn(() => true) }));

import { runEvalMenu } from '../../../src/cli/eval/eval-menu.js';
import { runListMenu } from '../../../src/cli/menus/list-menu.js';
import { runEvalScenarios } from '../../../src/cli/eval/custom-eval-menu.js';
import { runHumanEvalProblems } from '../../../src/cli/eval/humaneval-menu.js';
