...
vi.mock('../../../src/cli/eval/eval-screen.js', async (importOriginal) => {
  // eslint-disable-next-line @typescript-eslint/consistent-type-imports
  const actual = await importOriginal<typeof import('../../../src/cli/eval/eval-screen.js')>();
  return {
    ...actual,
...
import { buildCustomEvalTab, runEvalScenarios } from '../../../src/cli/eval/custom-eval-menu.js';
import type { CustomEval } from '../../../src/eval/custom.js';
import { CUSTOM_EVAL_DIR } from '../../../src/eval/custom.js';
import { VIEWPORT_SIZE } from '../../../src/cli/menus/list-menu.js';
